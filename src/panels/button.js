...
class ButtonPanel extends LitElement {
  ...
  render () {
    return html`
    <h2>Button</h2>
    <fw-select label="Color" value="secondary"  placeholder="Your choice" data-id="${this.dataset.id}" data-property="color">
    ...
    <fw-select label="Size" value="normal"  placeholder="Select size" data-id="${this.dataset.id}" data-property="size">
